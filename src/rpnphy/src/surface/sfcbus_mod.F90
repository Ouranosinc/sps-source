...
#define SFCVAR(MYVAR,MYNAME) type(SFCVAR_T) :: MYVAR = SFCVAR_T(-1,0,0,0,0,.false.,MYNAME)
   ...
   type :: SFCVARLIST_T
      ...
      SFCVAR(dsl, 'dsl')
      SFCVAR(dslc, 'dslc')
      SFCVAR(laipairatio, 'laipairatio')
      SFCVAR(laispaisratio, 'laispaisratio')
      SFCVAR(sfctdgat, 'sfctdgat')
      SFCVAR(rb, 'rb')
      SFCVAR(ngleafmas, 'ngleafmas')
      SFCVAR(vcmax0, 'vcmax0')
      SFCVAR(avesmfunc, 'avesmfunc')
      SFCVAR(redcoeff_vcmax, 'redcoeff_vcmax')
      SFCVAR(redcoeff_vcmaxMoss, 'redcoeff_vcmaxMoss')
      SFCVAR(stddevtopography, 'stddevtopography')
      SFCVAR(dsst, 'dsst')
      ...
      SFCVAR(er, 'er')
      SFCVAR(etr, 'etr')
      SFCVAR(evapotot, 'evapotot')
      SFCVAR(evapototaf, 'evapototaf')
      ...
      SFCVAR(potevaptr, 'potevaptr')
      SFCVAR(potevaptraf, 'potevaptraf')
      SFCVAR(pplus, 'pplus')
      SFCVAR(psi, 'psi')
   ...
   integer :: drainaf=0
   integer :: draintot=0
   integer :: draintotaf=0
   integer :: evapotot=0
   integer :: evapototaf=0
   integer :: fvapliqaf=0
   integer :: insmavg=0
   integer :: isoil=0
   integer :: latflw=0  
   ...
   integer :: trunofftot=0
   integer :: trunofftotaf=0
   integer :: watflow=0
   integer :: wflux=0
   integer :: wfluxaf=0
   integer :: wsoil=0
