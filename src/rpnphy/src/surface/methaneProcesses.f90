...
contains
  ...
  subroutine soil_ch4uptake (il1, il2, ilmos, ilg, tbar, & ! In
    ...
    !! Initialize to ensure values for non-soil grid cells are set to 0.
    CH4_soills = 0.0
  ...
  !> \ingroup methaneprocesses_wetlandMethane
  ...
  subroutine wetlandMethane (hetrores, il1, il2, ilg, wetfrac, &       ! inputs
