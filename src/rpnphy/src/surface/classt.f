...
cLD     8   EVPPOT, ACOND,  EVAPB,  GT,     QG,
     ...
     G   FSVF,   FSVFS,  PRESSG, VMOD,   VDIR,   
     g                                   ALVSCN, ALIRCN, ALVSG,  ALIRG,
...
!          VA(I)=MAX(VMIN,VMOD(I))
          VA(I)=VMOD(I)   ! use VMOD as calculated by sl_prelim in class_main
...
!     2                    ZDSLM,ZDSLH,RADJ,FCS,IL1,IL2,JL)
              CALL DIASURFZ(SU,SV,ST,SQ,ILG,VMOD,VDIR,
