...
! if (kount==0 .and. trnch==1 .and. n==11) then
...
! print*,'class_main RADSLOPE       :',RADSLOPE
! do j=1,NBS
...
! print*,'class_main ZEVAPOTOT      :',minval(ZEVAPOTOT),maxval(ZEVAPOTOT),sum(ZEVAPOTOT)/(N)
